...
insert into Answer(QuestionId, Content, IsTrue)
values (28, 'A. to by kopytka nie przerwa³a', 0)
insert into Answer(QuestionId, Content, IsTrue)
values (28, 'B. to by g³ówki nie wyrwa³a', 1)
insert into Answer(QuestionId, Content, IsTrue)
...
insert into Answer(QuestionId, Content, IsTrue)
values (29, 'A. Wrota otwórzcie siê', 0)
insert into Answer(QuestionId, Content, IsTrue)
values (29, 'B. Sezamie otwórz siê', 0)
insert into Answer(QuestionId, Content, IsTrue)
values (29, 'C. to by nó¿ki nie z³ama³a', 1)
insert into Answer(QuestionId, Content, IsTrue)
values (29, 'D. to by wina nie rozla³a ', 0)
